...
A responsive movie browsing apps built with **React + TypeScript + Vite**, powered by **TMDB APIs**. Users can explore **trending movies of the week** and search across **movies, TV shows, and people**.
